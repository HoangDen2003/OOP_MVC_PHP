    ...
    <div class="container-sm">
        <form class="col-6 mx-auto mt-5" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="id" readonly value="<?= $patient->getId() ?>">
            </div>
            <div class="form-group">
            ...
            if (isset($_POST['btn-primary'])) {
                header("Location: " . DOMAIN . "public/index.php?action=edit&id=" . $_POST["id"] . "&name=" . urlencode($_POST['name']) . "&gender=" . urlencode($_POST['gender']));
                exit();
            }
            ?>
        </form>
